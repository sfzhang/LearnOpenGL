...
int main()
{
    ...
    const char *fs_glsl[] = {
        ...
        "    frag_color = vec4(result * atten, 1.0f);\n"
        "}\n"
    };
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        */
        ...
        glUniform3f(glGetUniformLocation(shader_program, "light.pos"), cam_pos.x, cam_pos.y, cam_pos.z);
        glUniform3f(glGetUniformLocation(shader_program, "light.dir"), cam_front.x, cam_front.y, cam_front.z);
        glUniform1f(glGetUniformLocation(shader_program, "light.cutoff"), glm::cos(glm::radians(12.5f)));
        glUniform1f(glGetUniformLocation(shader_program, "light.outer_cutoff"), glm::cos(glm::radians(17.5f)));
