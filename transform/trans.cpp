...
int main()
{
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        /*
        xform = glm::rotate(xform, glm::radians(45.0f), glm::vec3(0.0, 0.0, 1.0));
        xform = glm::scale(xform, glm::vec3(0.5, 0.5, 0.5));
        */
        xform = glm::translate(xform, glm::vec3(0.5, 0.5, 0.0));
        xform = glm::rotate(xform, (float)glfwGetTime(), glm::vec3(0.0f, 0.0f, 1.0f));
        glUniformMatrix4fv(glGetUniformLocation(shader_program, "xform"), 1, GL_FALSE, glm::value_ptr(xform));
