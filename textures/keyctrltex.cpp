...
int main()
{
    ...
    const char *vs_glsl[] = {
        ...
        "out vec2 vertex_tex_coord2;\n" // flip awesomeface
        "void main() {\n"
        "    gl_Position = vec4(pos.x, pos.y, pos.z, 1.0);\n"
        "    vertex_color = vec4(color, 1.0f);\n"
        "    vertex_tex_coord = tex_coord;\n"
        "    vertex_tex_coord2 = vec2(1.0f - tex_coord.x, tex_coord.y);\n" // flip awesomeface
        "}\n"
    };
    ...
    const char *fs_glsl[] = {
        ...
        "in vec2 vertex_tex_coord2;\n" // flip awesomeface
        "out vec4 frag_color;\n"
        "uniform sampler2D tex1;\n"
        "uniform sampler2D tex2;\n"
        "uniform float ratio;\n"
        "void main() {\n"
        "    frag_color = mix(texture(tex1, vertex_tex_coord), texture(tex2, vertex_tex_coord2), ratio);\n"
        "}\n"
    };
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glUniform1f(glGetUniformLocation(shader_program, "ratio"), g_ratio);
